function BrotliDecodeClosure() {
        ...
        0 != i
          ? 1 == i
            ? 0 == t
              ? -1
              : ((e.c = 1),
                1 == H(e, 1) ? -1 : ((i = H(e, 6)), i < 10 || i > 30 ? -1 : i))
            : 8 + i
          : 17);
  }
  function r(e, t) {
    ...
    return 0 != e.n
      ...
      : ((e.O = new Int32Array(0)),
        ...
        void (
          ...
          0 == e.q &&
            ((e.I += e.o), e.I > 1 << 30 && (e.I = 1 << 30), e.J < e.H && Y(e)))
        ));
  }
  function k(e, t, i) {
    var n = e.j[2 * t];
  ...
  function A(e) {
    ...
    return (
      0 != t &&
        (e._.L(e.K.M(e.$, e.$ + t), e.aa + e.Y), (e.Y += t), (e.$ += t)),
      e.Y < e.X ? 1 : 0
    );
  }
  function I(e, t, i, n) {
    for (
      var a = le[(t + 31) >> 5], o = new Int32Array(i + i * a), r = i, s = 0;
      s < i;
      ++s
    )
      (o[s] = r), (r += $(e, t, o, s, n));
      ...
      switch (e.h) {
        ...
        case 7:
          if (0 != e.U) {
            ...
            for (
              var f = 255 & a[(e.W - 1) & n], p = 255 & a[(e.W - 2) & n];
              e.fa < e.da;
          ...
          if (
            (e.ha != e.ba && e.W < e.ba ? (e.ha = e.W) : (e.ha = e.ba),
            e.ga > e.ha)
          ) {
            e.h = 9;
            continue;
        ...
        case 8:
          ...
          if (x < n && I < n) {
            ...
            for (; e.fa < e.ea; )
              if (
                ((a[e.W] = a[(e.W - e.ga) & n]), e.o--, e.W++, e.fa++, e.W >= i)
              ) {
                (e.N = 8), (e.h = 12);
                break;
              }
        ...
        case 13:
          ...
          e.W >= e.ba && (e.ha = e.ba),
            e.W >= e.J &&
              (e.W > e.J && a.copyWithin(0, e.J, e.W), (e.W &= n), (e.$ = 0)),
            (e.h = e.N);
          continue;
        default:
  ...
  function z(e, t, i, n, a, o, r) {
    ...
    if (10 == p || 11 == p) {
      ...
      for (
        var Y = s - a, Q = o.ma[r], k = (32767 & Q) + (16777216 - (32768 & Q));
        a > 0;
